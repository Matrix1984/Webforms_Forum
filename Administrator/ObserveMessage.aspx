<%@ Page Title="" Language="C#" MasterPageFile="~/CP.master" AutoEventWireup="true" CodeFile="ObserveMessage.aspx.cs" Inherits="Administrator_ObserveMessage" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:Table ID="Table1" runat="server" Border="1" Height="124px" 
        ...
        style="z-index: 1; left: 158px; top: 340px; position: absolute; height: 124px; width: 700px">
     <asp:TableRow>
